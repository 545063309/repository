 ...
 <head>
  ...
  <body>
	...
	<div class="row">
		<div>
		     <div id="cartdiv">
		         <div class="floatleft"><h3>我的购物车</h3></div>
		         <div id="divcss1" class="forprice"><a class="btn btn-primary" href="clear" role="button">清空购物车</a>
		         <hr></hr>
		     </div>
				...
				<c:forEach items="${requestScope.cart_list }" var="cart">
					...
					<tr >
					    ...
					    <td class="showtd" style="vertical-align:middle;width:200px">
							选择购买数量<br/>
							<a class="btn btn-warning" href="add?good_id=${good.id}" role="button">+</a>${cart.count}<a class="btn btn-warning" href="reduce?good_id=${good.id}" role="button">-</a>
					    </td>
						<td class="showtd" style="vertical-align:middle">
							<a class="btn btn-info" href="saveorder?good_id=${good.id}&count=${cart.count}&order_state=未发货" role="button">立即购买</a>
					    </td>					    
					    <td class="showtd" style="vertical-align:middle">
							<a class="btn btn-danger" href="remove?good_id=${good.id}" role="button">删除</a>
					    </td>
					</tr>
					</c:forEach>
				</c:forEach>
