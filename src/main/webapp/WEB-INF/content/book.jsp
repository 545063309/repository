 	...
 	<div>
    	<div class="showdiv">
			...
			<c:forEach items="${requestScope.book_list}" var="good">
          	<td class="headimg"><div class="forimg" ><a href="detail?id=${good.id}"><img src="img/${good.good_image}" class="showimg"></a></div>
          	<br/>
            <div class="forname">${good.good_name}</div>
            <br/>
			<div class="forprice"><font color="red">￥${good.good_price}</font></div>
            </td>
            </c:forEach>
            </tr>
        </table>
